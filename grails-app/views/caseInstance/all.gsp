			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="Target DB" title="${message(code: 'caseInstance.targetDB.label', default: 'TargetDB')}" />
						
						<g:sortableColumn property="Duration" title="${message(code: 'caseInstance.duration.label', default: 'Duration')}" />
						
						<g:sortableColumn property="Executions" title="${message(code: 'caseInstance.nextExecutionNumber.label', default: 'Executions')}" />
				...
				<g:each in="${caseInstanceInstanceList}" status="i" var="caseInstanceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: caseInstanceInstance, field: "targetDB")}</td>
